"""
Brain Tumor Classification Model using MobileNetV2

This script implements a deep learning model for classifying brain tumor images
using a tuned MobileNetV2 architecture. It includes data loading, model
creation, training, evaluation, and result visualization.
...
def create_model():
    """
    Create and return the MobileNetV2-based model for brain tumor classification.
