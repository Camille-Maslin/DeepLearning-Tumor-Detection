"""
Brain Tumor Classification Model using CNN with Data Augmentation

This script implements a deep learning model for classifying brain tumor images
using a custom CNN architecture with data augmentation. It includes data loading,
model creation, training with augmented data, evaluation, and result visualization.
...
data_dir = os.path.join(parent_dir, "data", "data_augmente_data")
